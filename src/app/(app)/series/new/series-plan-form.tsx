...
function Chip({
  ...
  return (
    <button
      ...
      aria-pressed={active}
      className={cn(
        'flex h-11 items-center gap-2 rounded-[10px] border bg-black/30 px-3 text-left text-[13px] transition',
        active
...
function IconChip({
  ...
  return (
    <button
      ...
      aria-pressed={active}
      className={cn(
        'flex min-h-11 items-center gap-2 rounded-[10px] border bg-black/30 px-3 py-2 text-left text-[12px] font-medium transition',
        active
          ? 'border-[#0099ff] text-ink shadow-[0_0_0_1px_rgba(0,153,255,0.25)]'
          : 'border-white/10 text-ink-muted hover:border-white/25 hover:text-ink',
      )}
  ...
  return (
    <label className="flex flex-col gap-1.5">
      ...
      <input
        ...
        required={required}
        className="rounded-[10px] border border-white/10 bg-black/30 px-3 py-2 text-[14px] text-ink outline-none placeholder:text-[#666] focus:border-[#0099ff] focus:shadow-[0_0_0_1px_rgba(0,153,255,0.25)]"
      />
  ...
  return (
    <label className="flex flex-col gap-1.5">
      ...
      <input
        ...
        className="rounded-[10px] border border-white/10 bg-black/30 px-3 py-2 text-[14px] tabular-nums text-ink outline-none focus:border-[#0099ff] focus:shadow-[0_0_0_1px_rgba(0,153,255,0.25)]"
      />
      {error ? <span className="text-[12px] text-[#ff5577]">{error}</span> : null}
    </label>
  );
